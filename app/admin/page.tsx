    ...
    <DashboardLayout>
      <div className="space-y-8 font-inter">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl max-[1024px]:text-2xl font-bold tracking-tight text-zinc-900">
              Admin Dashboard
            </h1>
            <p className="text-zinc-500 max-[1024px]:text-sm mt-2">
              Manage exams, monitor students, create sessions and review
              violations.
            </p>
          </div>
          <div className="flex max-[1024px]:flex-col gap-4">
            ...
            <Button className=" max-[1024px]:text-sm">
          ...
          <TabsContent value="exams" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage your currently active and upcoming exams.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="rounded-md border border-zinc-200  overflow-x-scroll">
          ...
          <TabsContent value="violations" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Review flagged activities from recent exams.
                </CardDescription>
              </CardHeader>
              <CardContent>
